...
class BaseNavigation(XAPIBase):
    ...
    def get_data(self):
        ...
        e = self.get_randomized_event(event_id, actor_id, course, from_loc, to_loc, emission_time)
    ...
    def get_randomized_event(self, event_id, account, course, from_loc, to_loc, create_time):
        event = {
            "id": event_id,
            "actor": {
        ...
        if self.type == "link":
            ...
            event["context"]["extensions"]["http://id.tincanapi.com/extension/ending-point"] = to_loc
            event["context"]["extensions"]["http://id.tincanapi.com/extension/starting-position"] = from_loc
